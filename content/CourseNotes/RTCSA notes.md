...
- <span style="background:#d3f8b6">write through & write back</span>🔄
	- write through
		- simple, all write operations are made to the main memory as well as to the cache (memory和cache都写上)
...
<span style="background:#d3f8b6">MESI protocol</span>🔄
...
#### task
🔄<span style="background:#d3f8b6">categories of task</span>
...
<span style="background:#d3f8b6">2 types of real-time system</span>🔄
...
<span style="background:#d3f8b6">3 types</span>🔄
1. priority based
	1. fixed priority
	2. dynamic priority
